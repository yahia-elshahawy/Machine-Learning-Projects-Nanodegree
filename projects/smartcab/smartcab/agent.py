...
class LearningAgent(Agent):
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
			self.Q[state][action] = (1 - self.alpha) * self.Q[state][action] + self.alpha * reward # not considering future rewards or discount factor
        return
...
def run():
    ...
    sim.run(n_test = 10,tolerance = .005)
